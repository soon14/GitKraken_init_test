...
public class Tc_usercrdtm_in extends Tc_usercrdtm_inKey {

	@Override
	public String toString() {
		return "Tc_usercrdtm_in [username=" + username + ", carcode=" + carcode + ", chargeruleid=" + chargeruleid
				+ ", carlabel=" + carlabel + ", carcolor=" + carcolor + ", carstyleid=" + carstyleid + ", crdtm="
				+ crdtm + ", lastouttime=" + lastouttime + ", carintype=" + carintype + ", channelid=" + channelid
				+ ", imagepath=" + imagepath + ", recognizecarcode=" + recognizecarcode + ", note=" + note
				+ ", carcode2=" + carcode2 + ", parkinglotno=" + parkinglotno + ", parkinglocation=" + parkinglocation
				+ ", areaid=" + areaid + "]";
	}
