...
public interface Tc_usercrdtm_inMapper {
    ...
    List<Tc_usercrdtm_in> selectByParknoAndNumber(@Param("parkinglotno")String parkinglotno,@Param("topsize")Integer topsize);

    Tc_usercrdtm_in queryParkingStatebyCarCode(@Param("carcode") String carcode,@Param("parkinglotno") String parkinglotno,@Param("partitionID") int partitionID);
    Tc_usercrdtm_in queryLaterCode(@Param("carcode") String carcode,@Param("parkinglotno") String parkinglotno,@Param("datetime") Date datetime);
    int delcarfrom_in(@Param("carcode") String carcode,@Param("parkinglotno") String parkinglotno,@Param("partitionID") int partitionID);
    
    void batchInsertUsercrdtm_in(ArrayList<Tc_usercrdtm_in> list);
  ...
  //  Public User selectUser(@param("userName") String name,@param("userArea")String area);
    ...
    void batchReplaceOldUsercrdtm_in(ArrayList<Tc_usercrdtm_in> list);
    ...
    //Tc_usercrdtm_in selectcarin(@Param("carcode") String carcode,@Param("parkinglotno") parkinglotno);
