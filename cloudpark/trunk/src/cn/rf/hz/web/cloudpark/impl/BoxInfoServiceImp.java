						...
						if (stationid != null && !stationid.isEmpty()) {
							...
							if (channellist != null && channellist.size() > 0) {
								for (int n = 0; n < channellist.size(); n++) {
									...
									if (Integer.valueOf(parkingbox.getParkinglotno()) >= 8000
											&& Integer.valueOf(parkingbox.getParkinglotno()) <= 9000) {
							...
							String parkinglotno = parkingbox.getParkinglotno();
...
//							}
							...
							parkingparm = new Pb_parkingparm();
							String isuploadunlicensedcarimage = ParkingLotConfigUtil.GetParkingLotConfig("isuploadunlicensedcarimage");
							parkingparm = parkingparmMapper.selectByPrimaryKey(parkinglotno,
