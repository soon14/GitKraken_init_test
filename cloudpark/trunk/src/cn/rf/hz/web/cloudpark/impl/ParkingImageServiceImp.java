		...
		try {
			...
			if (usercrdtmin != null && usercrdtmin.size() > 0) {
				...
				for (int i = 0; i < usercrdtmin.size(); i++) {
					...
					model.put("imagePath",
							newImagePath
									.replace("http://cloudpark.oss-cn-hangzhou.aliyuncs.com",
											"http://cloud.parking24.cn:9090")
									.replace("http://cloudpark.vpc100-oss-cn-hangzhou.aliyuncs.com",
											"http://cloud.parking24.cn:9090"));
		...
		if (inPath != null && !inPath.isEmpty()) {
			try {
				...
				if (ImageUrl != null && !ImageUrl.isEmpty()) {
					result.put("inUrl",
							ImageUrl.replace("http://cloudpark.oss-cn-hangzhou.aliyuncs.com",
									"http://cloud.parking24.cn:9090")
									.replace("http://cloudpark.vpc100-oss-cn-hangzhou.aliyuncs.com",
											"http://cloud.parking24.cn:9090"));
	...
	public JSONObject batchGetSmallImagePath(String requestBody) {
		...
		try {
			...
			for (int i = 0; i < arraypath.length; i++) {
				...
				if (ImageUrl != null && !ImageUrl.isEmpty()) {
					iamgeUrls += ImageUrl
							.replace("http://cloudpark.oss-cn-hangzhou.aliyuncs.com", "http://cloud.parking24.cn:9090")
							.replace("http://cloudpark.vpc100-oss-cn-hangzhou.aliyuncs.com",
									"http://cloud.parking24.cn:9090");
